...
namespace ApdaterPatternClassicalApproach {
    ...
    // create concrete class 'AudioPlayer' implementing 'MediaPlayer' interface
 ...
 */
static void clientCode(std::shared_ptr<ApdaterPatternClassicalApproach::MediaPlayer>& player) {
